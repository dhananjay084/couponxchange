    ...
    >
      ...
      >
        <div className="grid grid-cols-1 lg:grid-cols-5">
          <div className="lg:col-span-2 bg-gradient-to-br from-orange-100 via-amber-50 to-orange-200 p-6 border-r border-orange-100">
            <div className="flex items-center gap-3 mb-4">
              <Image src={Logo} alt="CouponXchange" width={110} height={36} />
            </div>
            <h3 className="text-2xl font-bold text-orange-700 leading-tight">
              Submit your best coupon deal
            </h3>
            <p className="mt-3 text-sm text-orange-900/85">
              Share verified coupon details. Our admin team reviews and publishes approved submissions.
            </p>
            <div className="mt-6 space-y-2 text-sm text-orange-900">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                <input
                  ...
                  className="border p-2.5 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-400"
                  required
                />
                <input
                  name="dealTag"
              ...
              <textarea
                ...
                className="w-full border p-2.5 rounded-lg min-h-[90px] focus:outline-none focus:ring-2 focus:ring-orange-400"
              />
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                <div>
                  <input
                    ...
                    className="w-full border p-2.5 rounded-lg mb-2 focus:outline-none focus:ring-2 focus:ring-orange-400"
                  />
                  <select
                    name="dealStore"
                    value={formData.dealStore}
                    onChange={handleChange}
                    className="w-full border p-2.5 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-400"
                    required
                  >
              ...
              <div className="flex justify-end">
                <button
                  type="submit"
                  disabled={submitting}
                  className="bg-orange-600 text-white px-6 py-2.5 rounded-lg font-medium hover:bg-orange-700 disabled:opacity-70"
                >
